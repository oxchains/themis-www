...
class Ourteams extends Component {
    ...
    render() {
        const imgLinks = [
            ...
            {
                src: '../public/img/zhaohui.jpg',
                name: '晁辉',
                info: "支付系统专家，原雪球网高级总监，曾在阿里巴巴支付宝担任资深架构师，资深互联网技术和产品技术管理专家，拥有十五年大型金融和互联网系统研发和管理经验。负责Themis区块链支付协议开发。"
            },
            {
                src: '../public/img/huchengjian.png',
                name: '胡成建',
                info: "北京大学工学硕士。开发了基于改进BFT共识机制的高速私有区块链（北航链），是国内最早的区块链参与者和开发人员。负责Themis区块链共识算法的实现。"
            },
            {
                src: '../public/img/EnnanZhai.png',
                name: 'Ennan Zhai',
                info: "耶鲁大学博士、博士后，耶鲁大学副研究员，主要研究方向为声誉系统和大规模分布式系统。负责Themis声誉系统的设计和实现。"
            },
            {
                src: '../public/img/guanzhi.png',
                name: '关志',
                info: "北京大学理学博士，北京大学副研究员，密码学和安全协议专家，著名国密算法开源项目GmSSL的主要开发者和社区领袖，培养了北大最早的三名区块链方向硕士研究生。负责Themis钱包和相关密码学增强算法的设计和实现。"
            },
            {
                src: '../public/img/chenyu.png',
                name: '陈宇',
                info: "北京大学理学博士，中国科学院信息工程研究所信息安全国家重点实验室副研究员、硕士生导师，主要研究方向为公钥密码学、可证明安全理论、基本密码组件。负责Themis密码学算法、公平交换协议的设计和实现。"
            },
            {
                src: '../public/img/xinwei.jpg',
                name: '辛伟',
                info: "北京大学理学博士，中国信息安全测评中心高级工程师。专注安全漏洞检测和密码算法安全性分析，有丰富的区块链自动化漏洞检测经验。负责Themis系统和其智能合约安全漏洞检测。"
            },
            {
                src: '../public/img/wangliyan.png',
                name: '王李琰',
